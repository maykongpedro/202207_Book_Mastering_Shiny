...
recommendation <- tibble::tribble(
          ~Account, ~Product, ~Region, ~Revenue,
       "Axis Bank",    "FBB", "North",    2000L,
            "HSBC",    "FBB", "South",   30000L,
             "SBI",    "FBB",  "East",    1000L,
           "ICICI",    "FBB",  "West",    1000L,
    "Bandhan Bank",    "FBB",  "West",     200L,
       "Axis Bank",   "SIMO", "North",     200L,
            "HSBC",   "SIMO", "South",     300L,
             "SBI",   "SIMO",  "East",     100L,
           "ICICI",   "SIMO",  "West",     100L,
    "Bandhan Bank",   "SIMO",  "West",     200L
    )


# recommendation <-
#     read.csv('https://github.com/Appsilon/semantic.dashboard/blob/develop/examples/sales/recommendation.csv',
